    ...
    return(
        <div>
            ...
            <div style={{marginTop:'20px'}}>
                <TableComponent handleDeleteMany={handleDeleteManyProducts} columns={columns} isPending={isPending} data={dataTable} 
                ...
                <ModalComponent
                    ...
                    <Form.Item
                        label="Image"
                        name="image"
                        rules={[{ required: true, message: 'Please upload image of product!' }]}
                    >
                        <WrapperUploadFile 
                ...
                >
                    <Loading1 isPending={isPendingDeleted}>
                        <div>Bạn có chắc là muốn xóa sản phẩm này không ?</div>
                    </Loading1>
                </ModalComponent>
        </div>
    )
